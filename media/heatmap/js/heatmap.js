...
(function(w){
    ...
    heatmap.prototype = {
        configure: function(config){
                ...
                me.set("radiusIn", config.grRadIn || 15),
                me.set("radiusOut", config.grRadOut || 40),
        ...
        init: function(){
                ...
                bgCanvas.width = me.get("width");
                bgCanvas.height = me.get("height");
                
                bgCanvas.style.position = "absolute";
                bgCanvas.style.left = 0;
                bgCanvas.style.top = 0;
                
                var bgCanvasC = bgCanvas.getContext("2d");
                
                bgCanvasC.globalAlpha = 0.6;
                
                bgCanvasC.fillStyle = '#98D1F5';
                bgCanvasC.fillRect(0, 0, bgCanvas.width, bgCanvas.height);
                
                me.get("element").appendChild(bgCanvas);
